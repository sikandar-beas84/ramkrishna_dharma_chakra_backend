...
@section('title')
<title>Shree RamKrishna Dharma Chakra | Manage Parampara Edit</title>
@endsection
...
<div class="content-page">
	...
	<div class="content">
		<div class="wraper container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Manage Parampara Edit</h4>
					<ol class="breadcrumb pull-right">
                        <li class="active"><a href="{{route('admin.manage.social-activities')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a></li>
                    </ol>
				</div>
			</div>
					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('admin.manage.social-activities.update')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
									...
									{{-- preview-image --}}
                                   <div class="form-group rm03">
                                    <img style="width: 50%;height: 400px" id="img2" src="{{URL::to('storage/social')}}/{{@$data->image}}">
                                   </div>
