...
@section('title')
<title>Shree RamKrishna Dharma Chakra | Manage Social Activities Add</title>
@endsection
...
<div class="content-page">
	...
	<div class="content">
		<div class="wraper container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Manage Social Activities Add</h4>
					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('admin.manage.social-activities.add')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
