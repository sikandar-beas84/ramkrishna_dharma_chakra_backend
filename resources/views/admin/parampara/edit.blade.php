					...
					<div>
						...
						<div class="panel panel-default panel-fill">
							...
							<div class="panel-body rm02 rm04">
								<form role="form" action="{{route('admin.manage.parampara.update')}}" id="frm" method="post" enctype="multipart/form-data">
									@csrf
									...
									{{-- preview-image --}}
                                   <div class="form-group rm03">
                                    <img style="width: 50%;height: 400px" id="img2" src="{{URL::to('storage/parampara')}}/{{@$data->image}}">
                                   </div>
