...
<link href="{{ URL::asset('frontend/croppie/croppie.css') }}" rel="stylesheet" />
<link href="{{ URL::asset('frontend/croppie/croppie.min.css') }}" rel="stylesheet" />
<style type="text/css">
   .error{
      color: red;
   }
                            ...
                            <div class="panel-body rm02 rm04">
                                <form role="form"  method="POST" action="{{route('admin.manage.profile.update')}}" id="profile_form" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="First Name" id="oldpassword" class="form-control" name="first_name" required value="{{auth()->guard('admin')->user()->first_name}}">
                                        <div id="err_category"></div>
                                    </div>

                                    <div class="form-group">
                                        <label for="category_name">Last Name</label>
                                        <input type="text" placeholder="Last Name" id="oldpassword" class="form-control" name="last_name" required value="{{auth()->guard('admin')->user()->last_name}}">
                                        <div id="err_category"></div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" placeholder="Phone Number" id="email" class="form-control" name="ph_number" required value="{{auth()->guard('admin')->user()->ph_number}}">
                                    </div>

                                    <div class="form-group rm03">
                                                <label for="AboutMe">About</label>
                                                <textarea class="form-control" name="about" style="height: 150px;">{{auth()->guard('admin')->user()->about}}</textarea>
                                    </div>

                                    <div class="form-group rm03">
                                                <label for="AboutMe">Address</label>
                                                <textarea class="form-control" name="address" style="height: 150px;">{{auth()->guard('admin')->user()->address}}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="uplodimgfil">
                                           ...
                                           {{--  <input type="file" id="icon" name="image"  class="inputfile inputfile-1">
                                            ...
                                            <label for="icon">Upload Profile Picture<img src="{{ URL::to('admin/assets/images/clickhe.png')}}" alt=""></label>
                                        </div>
                                       <div id="err_icon"></div>
                                  </div>
                                  ...
                                  <div class="uplodimgfilimg">
                                    <em>
                                  <img src="{{ URL::to('storage/admin_image')}}/{{auth()->guard('admin')->user()->image}}" alt="" id="img2">
                                  </em>
                                </div>  
