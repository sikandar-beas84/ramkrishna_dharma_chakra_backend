...
@section('body')
  ...
  margin-top: 80px;
  display: flex;
  background: url({{url('/')}}/storage/banner_min/{{$banner->image}});
      ...
      <div class="max-theme-width">
        <div class="row display-flex align-items-center">
          <div class="col-md-6 col-12 my-3">
            <div class="lab-img">
              <img src="{{ URL::to('storage/about')}}/{{@$why->image}}" alt="" />
            </div>
          </div>
          <div class="col-md-6 col-12 my-3">
            <div class="lab-content">
              ...
              <div class="lists">
                <img src="{{asset('frontend/assets/img/doctor/check.png')}}" alt="" />
                <p class="text">
                  {{@$why->heading_one}}
                </p>
              </div>
      ...
      <div class="max-theme-width">
        ...
        <div class="provider-img-box">
          ...
          <div class="provider-left-box">
            <img src="{{ URL::to('storage/provider_min')}}/{{@$value->image}}" alt="" />
          </div>
          @endforeach
        ...
        <div class="row display-flex align-items-center reverse">
          ...
          <div class="col-md-6 col-12 my-3">
            <div class="common-content">
              ...
              <div class="btn-div my-3">
                <button class="btn common-btn">Products info</a> <img src="{{asset('frontend/assets/img/doctor/play.png')}}" alt=""></button>
          ...
          <div class="col-md-6 col-12 my-3">
            <div class="common-img">
              <img src="{{ URL::to('storage/common_min')}}/{{@$common->image}}" alt="" />
            </div>
          </div>
        </div>
      </div>
